...
public enum CourseErrorStatus implements BaseCode {
    ...
    INVALID_COURSE_PLACE(HttpStatus.BAD_REQUEST, "COURSE_400_04", "해당 코스에 속한 장소가 아닙니다."),
    SAME_ORIGIN_DESTINATION(HttpStatus.BAD_REQUEST, "COURSE_400_05", "출발지와 도착지가 동일합니다."),
    ROUTE_NOT_FOUND(HttpStatus.NOT_FOUND, "COURSE_404_05", "경로를 찾을 수 없습니다.");
